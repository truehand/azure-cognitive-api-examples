...
endpoint = config[0]['azure']['vision_endpoint']
key = config[0]['azure']['vision_key']
print(endpoint)
...
# <snippet_remoteimage>
remote_image_url = "https://raw.githubusercontent.com/Azure-Samples/cognitive-services-sample-data-files/master/ComputerVision/Images/landmark.png"
# </snippet_remoteimage>
'''
...
local_image_path_landmark = os.path.join (images_folder, "landmark.png")
